...
function addRandomMarker() {
    if(currentLocation){
    var randomLat = currentLocation.latitude + Math.floor(Math.random() * (0.001 - 0.0001)) + 0.0001
    var randomLng = currentLocation.longitude + Math.floor(Math.random() * (0.001 - 0.0001)) + 0.0001
    const locationsRef = database.ref('locations');
